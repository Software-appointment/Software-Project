...
class DurationRuleTest {
    ...
    @Test
    void testDurationValid_30Minutes() {
    ...
    @Test
    void testDurationValid_60Minutes() {
    ...
    @Test
    void testDurationValid_120Minutes() {
    ...
    @Test
    void testDurationInvalid_45Minutes() {
    ...
    @Test
    void testDurationInvalid_90Minutes() {
    ...
    @Test
    void testDurationInvalid_0Minutes() {
    ...
    private static class TestReservation extends Reservation {
        ...
        TestReservation(String id, String date, String time, int duration, MeetingRoom room) {
