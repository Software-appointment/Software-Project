...
class DomainTest {
    ...
    @Test
    void testAdministrator_toString() {
        Administrator admin = new Administrator("A001", "admin", "1234");
    ...
    @Test
    void testNotificationMessage_gettersAndSetters() {
    ...
    @Test
    void testNotificationMessage_toString() {
        NotificationMessage msg = new NotificationMessage("N001", "Reminder", "2026-04-09");
    ...
    @Test
    void testCateringService_getters() {
