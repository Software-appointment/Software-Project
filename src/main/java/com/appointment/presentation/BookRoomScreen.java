...
public class BookRoomScreen extends JPanel {
     ...
     */
    public BookRoomScreen(ReservationService reservationService, RoomService roomService, String username) {
    ...
    private void buildUI() {
        ...
        userNameField.setBackground(new Color(232, 245, 233));
        ...
        cateringCombo.setBackground(new Color(255, 248, 225));
        ...
        cateringCheckBox.addActionListener(e -> {
        ...
        bookBtn.setForeground(new Color(27, 94, 32));
    ...
    private Reservation createReservation(String type, String date,
        ...
        switch (type) {
            case "Group":      return new GroupReservation(id, date, time, duration, room, 2);
            case "Virtual":    return new VirtualReservation(id, date, time, duration, room);
            case "InPerson":   return new InPersonReservation(id, date, time, duration, room);
            case "Urgent":     return new UrgentReservation(id, date, time, duration, room);
            case "FollowUp":   return new FollowUpReservation(id, date, time, duration, room);
            case "Assessment": return new AssessmentReservation(id, date, time, duration, room);
            default:           return new IndividualReservation(id, date, time, duration, room);
        }
    }
